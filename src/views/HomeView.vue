<template>
  <div class="relative h-screen overflow-hidden before:block before:absolute before:h-full before:w-full before:top-0 before:left-0 before:z-10 before:bg-black before:opacity-30">
    <img src="../assets/images/hitachi.jpg" class="grayscale-[75%] md:hidden absolute top-0 left-0 min-h-full ob" alt="">
    ...
    <div class="relative z-20 max-w-screen-lg mx-auto grid grid-cols-12 h-full items-center">
      <div id="fade" class="col-span-6">
        <span class="uppercase text-white text-xs font-bold mb-2 block ml-6 md:ml-0">
          WE ARE EXPERTS
        </span>
        <h1 class="text-white font-extrabold mb-6 lg:text-5xl sm:text-2xl ml-6 md:ml-0">
          Step into the future of machine control with Intelsys.
        </h1>
        ...
        <a class="ml-6 md:ml-0" href="/#/what-we-do">
          <button class="mt-8 text-white uppercase py-4 text-base font-semibold px-10 border border-white hover:bg-white hover:bg-opacity-10">
            learn more
          </button>
        </a>
      </div>
